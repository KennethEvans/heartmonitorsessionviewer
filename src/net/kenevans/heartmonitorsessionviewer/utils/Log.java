...
{
    /** Strings for priorities */
    private static final String[] priorityString = {"?", "?", "V", "D", "I",
        "W", "E", "A"};
    ...
    public static int w(String tag, Throwable tr) {
        return print(WARN, tag, getStackTraceString(tr));
    }
    ...
    public static int wtf(String tag, String msg, Throwable tr) {
        ...
        int bytes = print(ASSERT, tag, msg + '\n' + getStackTraceString(tr));
     ...
     * @hide
     */
    public static TerribleFailureHandler setWtfHandler(
    ...
    public static int print(int priority, String tag, String msg) {
        System.out.println(priorityString[priority] + " " + tag + " " + msg);
        return 0;
    }
}
